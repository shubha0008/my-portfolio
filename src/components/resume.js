      ...
      <div>
        <Grid>
          <Cell col={4}>
            ...
            <p>Looking Forward to Switch from Service based projects to Product Based project . I am always looking out for and learning new technologies that help me do a better job . I am passionate / curious / interested about my craft / profession, my professional community.</p>
            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}}/>
            <h5>Address</h5>
